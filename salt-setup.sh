...
# TODO do we need the salt-event-proxy
...
sudo wget -O /usr/lib/systemd/system/salt-event-proxy.service https://raw.githubusercontent.com/byuoitav/flight-deck/master/image/salt-event-proxy.service
